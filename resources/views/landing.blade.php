    ...
    <section id="download" class="py-24 relative z-10 bg-black/20">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="flex justify-center">
                <a href="https://drive.google.com/file/d/1SVdiraZ_pnWXJIRi8E2lMjeBBYOi84s8/view?usp=sharing" class="px-8 py-4 rounded-xl bg-app-primary text-app-bg font-bold text-lg hover:shadow-[0_0_30px_rgba(79,216,235,0.4)] transition-all flex items-center justify-center gap-3 group">
